const PLOT_DATA_MAPPING = {
  '251/2': { klasa: 'INWESTYCYJNA', size: 1456, status: 'commonInteractive', typeOverride: 'common', title: 'Strefa zieleni wspólnej', heading: 'Zielony bufor od drogi', featureLabel: 'Funkcja', featureValue: 'pas zieleni izolacyjnej', description: 'Docelowa strefa zieleni osłaniająca osiedle od strony drogi. Przewidziane są nasadzenia drzew i krzewów oraz estetyczne uporządkowanie terenu jako zielony bufor dla mieszkańców.', photo: '/assets/contact-bg.jpg' },
  '265/1': { klasa: 'INWESTYCYJNA', size: 1464, status: 'commonInteractive', typeOverride: 'common', title: 'Strefa zieleni wspólnej', heading: 'Zielony bufor od drogi', featureLabel: 'Funkcja', featureValue: 'zielona osłona osiedla', description: 'Teren wspólny projektowany jako spokojny, zielony bufor przy wjeździe. Ma wzmacniać prywatność zabudowy i porządkować kontakt osiedla z drogą publiczną.', photo: '/assets/contact-bg.jpg' },
  '265/2': { klasa: 'PARK', size: 915, status: 'commonInteractive', typeOverride: 'common', title: 'Wspólna zieleń i sady', heading: 'Sad jabłoni · park kieszonkowy', featureLabel: 'Charakter', featureValue: 'sad jabłoni i miejsce odpoczynku', description: 'Teren wspólny pomyślany jako mały park kieszonkowy z nasadzeniami jabłoni. Docelowo może stać się kameralnym miejscem spacerów, sąsiedzkich spotkań i zielonym sercem tej części osiedla.', photo: '/assets/hero-bg.jpg' },
  '251/3': { klasa: 'PARK', size: 933, status: 'commonInteractive', typeOverride: 'common', title: 'Wspólna zieleń osiedla', heading: 'Zieleń wspólna · strefa rekreacyjna', featureLabel: 'Charakter', featureValue: 'zieleń urządzona i nasadzenia', description: 'Wspólny teren zielony uzupełniający układ osiedla. Przewidziany pod zieleń urządzoną, nasadzenia oraz spokojną przestrzeń poprawiającą jakość otoczenia mieszkańców.', photo: '/assets/plot-panorama.jpg' },

  // ETAP I — cennik START brutto 17.09.2026
  // Cena publiczna jest ceną całkowitą brutto; udział w drodze nie jest doliczany klientowi osobno.
  '251/4': { klasa: 'PRYWATNA', etap: 'I', size: 1129, priceNetto: 109756, priceBrutto: 135000, pricePerM2Netto: 97 },
  '265/3': { klasa: 'FUNKCJONALNA', etap: 'I', size: 1184, priceNetto: 104878, priceBrutto: 129000, pricePerM2Netto: 89 },
  '251/5': { klasa: 'PRYWATNA', etap: 'I', size: 1129, priceNetto: 109756, priceBrutto: 135000, pricePerM2Netto: 97 },
  '265/4': { klasa: 'FUNKCJONALNA', etap: 'I', size: 1187, priceNetto: 105691, priceBrutto: 130000, pricePerM2Netto: 89 },
  '251/6': { klasa: 'PRYWATNA', etap: 'I', size: 1129, priceNetto: 109756, priceBrutto: 135000, pricePerM2Netto: 97 },
  '265/5': { klasa: 'FUNKCJONALNA', etap: 'I', size: 1190, priceNetto: 106504, priceBrutto: 131000, pricePerM2Netto: 89 },
  '265/31': { klasa: 'FUNKCJONALNA', etap: 'I', size: 900, priceNetto: 93496, priceBrutto: 115000, pricePerM2Netto: 104 },
  '265/30': { klasa: 'FUNKCJONALNA', etap: 'I', size: 901, priceNetto: 95122, priceBrutto: 117000, pricePerM2Netto: 106 },
  '265/29': { klasa: 'PANORAMA', etap: 'I', size: 944, priceNetto: 104878, priceBrutto: 129000, pricePerM2Netto: 111 },
  '265/28': { klasa: 'PANORAMA', etap: 'I', size: 989, priceNetto: 108130, priceBrutto: 133000, pricePerM2Netto: 109 },
  '265/27': { klasa: 'PANORAMA', etap: 'I', size: 989, priceNetto: 102439, priceBrutto: 126000, pricePerM2Netto: 104 },
  '265/26': { klasa: 'PANORAMA', etap: 'I', size: 1035, priceNetto: 104878, priceBrutto: 129000, pricePerM2Netto: 101 },
  '265/25': { klasa: 'PANORAMA', etap: 'I', size: 1035, priceNetto: 104878, priceBrutto: 129000, pricePerM2Netto: 101 },
  '265/24': { klasa: 'PANORAMA', etap: 'I', size: 1035, priceNetto: 104878, priceBrutto: 129000, pricePerM2Netto: 101 },
  '265/23': { klasa: 'PANORAMA', etap: 'I', size: 1035, priceNetto: 106504, priceBrutto: 131000, pricePerM2Netto: 103 },
  '265/6': { klasa: 'FUNKCJONALNA', etap: 'I', size: 1193, priceNetto: 100000, priceBrutto: 123000, pricePerM2Netto: 84 },
  '251/7': { klasa: 'PRYWATNA', etap: 'I', size: 1129, priceNetto: 104065, priceBrutto: 128000, pricePerM2Netto: 92 },
  '265/7': { klasa: 'FUNKCJONALNA', etap: 'I', size: 1210, priceNetto: 101626, priceBrutto: 125000, pricePerM2Netto: 84 },
  '251/8': { klasa: 'PRYWATNA', etap: 'I', size: 1140, priceNetto: 104878, priceBrutto: 129000, pricePerM2Netto: 92 },
...
function typeFromClass(klasa, typeOverride){
...
function typeLabel(type){
  if(type === 'common') return 'Teren wspólny';
  return type === 'panorama' ? 'Panorama' : type === 'kameralna' ? 'Kameralna' : 'Funkcjonalna';
}
function statusFor(data){
  // Opcjonalny status ręczny pozwala później przełączać pojedynczą działkę bez zmian geometrii.
  if(['available','reserved','sold','commonInteractive','stage2'].includes(data.status)) return data.status;
...
function statusLabel(status){
  ...
  if(status === 'sold') return 'Sprzedana';
...
export const PLOTS = Object.entries(ID_TO_GEODETIC).map(([rawIdText, id]) => {
  ...
  const type = typeFromClass(data.klasa, data.typeOverride);
  ...
  return {
    ...
    sellable:['available','reserved','sold'].includes(status),
    mapSelectable:['available','reserved','sold','commonInteractive'].includes(status),
    hoverable:['available','reserved','sold','commonInteractive','stage2'].includes(status),
